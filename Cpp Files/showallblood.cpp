...
showAllBlood::showAllBlood(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::showAllBlood)
{
    ui->setupUi(this);
}

showAllBlood::~showAllBlood()
{
    delete ui;
}

void showAllBlood::on_pushButton_clicked()
{
...
void showAllBlood::on_BackButton_clicked()
{
    hide();
}
